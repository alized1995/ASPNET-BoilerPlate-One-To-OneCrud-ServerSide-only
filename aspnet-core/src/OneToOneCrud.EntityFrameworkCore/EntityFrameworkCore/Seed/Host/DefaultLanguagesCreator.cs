...
namespace OneToOneCrud.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly OneToOneCrudDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = OneToOneCrudConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(OneToOneCrudDbContext context)
        {
            _context = context;
        }
