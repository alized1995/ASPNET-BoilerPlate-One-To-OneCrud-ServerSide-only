...
{
    public abstract class OneToOneCrudWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OneToOneCrudWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OneToOneCrudWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OneToOneCrudDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OneToOneCrudDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OneToOneCrudDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OneToOneCrudDbContext, Task<T>> func)
        {
            T result;
